...
namespace SupplyChain.WebUI.Areas.Orders.Controllers
{
    public class ProductsController : Controller
    {
        ...
        //to do: to be consumed by the purchase and sales cart items, consider moving it to a web api controller
